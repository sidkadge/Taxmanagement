                                ...
                                <form id="adminForm" method="POST" action="<?=base_url(); ?>register">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-4">
                                            <label for="Alternate_name">Alternate person Name</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-2">
                                            ...
                                            <input id="Floor" placeholder="floor no" type="text" class="form-control" name="Floor">
                                        </div>
                                        <div class="form-group col-2">
                                            <label for="Flat">Flat*</label>
                                            <input id="Flat" placeholder="Flat no" type="text" class="form-control" name="Flat">
                                        </div>
